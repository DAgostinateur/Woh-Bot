...
# Text at the beggining of each help message:
...
ADD_CHANNEL_BD_ALREADY = "**There's already a channel for birthday messages in this server**, delete the current one to change it."
...
# woh:
MORE_HELP_WOH = "Command: {0}\nWhen the command is called, the bot will send you the list of commands that you have permission to use."
